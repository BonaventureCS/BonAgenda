...
public class DBAdapter {
	...
	// --retrieves all events---
		public Cursor getDayEvents(String date) {
			return db.query(DATABASE_TABLE_EVENTS, new String[] { KEY_ROWID,
					KEY_TITLE, KEY_DATE, KEY_DESCRIPTION, KEY_TIME, KEY_TYPE },
	...
	// ---updates an event---
	public boolean updateEvent(long rowId, String title, String date, String description, String time, String type) {
		ContentValues args = new ContentValues();
		args.put(KEY_TITLE, title);
