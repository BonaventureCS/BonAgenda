...
public class UpdateNoteActivity extends Activity {
	...
	public void addNote(View v)
	{
	  ...
	  EditText notesTxt = (EditText)findViewById(R.id.editNote);
	       ...
	       db.open();        
	       boolean pass = db.updateNote(passedID, nameTxt.getText().toString(), notesTxt.getText().toString());        
	
	       db.close();
	       
	    title.setText("");
	    note.setText("");
        Toast.makeText(UpdateNoteActivity.this,"Note Updated", Toast.LENGTH_LONG).show();  
